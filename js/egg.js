...
function setCookieOneDay(cname, cvalue, exdays) {
  const d = new Date();
...
function julio_egg(){
  ...
  // if (new Date() < new Date('2024-12-11T11:30:00')) {
  //   console.log(true); // La fecha actual aún no ha llegado
  // } else {
  //   console.log(false); // La fecha actual ya ha pasado
  // }
